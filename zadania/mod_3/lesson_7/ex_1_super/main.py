...
def run_example():
    ...
    department = Department(letter_identifier="C", year=1)
    ...
    not_qualified = assign_students_to_department(department, students)
    not_qualified += assign_students_to_department(department, not_qualified_bio_chem)
    not_qualified += assign_students_to_department(department, not_qualified_math_physics)
