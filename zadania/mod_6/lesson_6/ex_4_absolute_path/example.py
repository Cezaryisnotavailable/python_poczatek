...
def process_text_file(file_path):
    ...
    print("Dane z pliku to:")
    print(text_data)


def run_example():
    absolute_path = "X:\OneDrive - Akademia Leona Kozminskiego\PyCharm projects\PYthON Poczatek\zadania\mod_6\lesson_6\ex_4_absolute_path\plain_text.txt"
