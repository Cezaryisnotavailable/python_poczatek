...
def find_best_grade(subject_with_final_grade):
    best_subject = None
    best_final_grade = 0
    # for subject, final_grade in subject_with_final_grade.items():
    #     if final_grade > best_final_grade:
    #         best_final_grade = final_grade
    #         best_subject = subject
    # return best_subject, best_final_grade

    for element in subject_with_final_grade.items():
        print(type(element))
        subject = element[0]
...
def run_example():
    ...
    # }
    #
    # best_subject, best_grade = find_best_grade(subjects_with_grades)
    # print(best_subject, best_grade)
    # result = find_best_grade(subjects_with_grades)
    # print(result)
    # print(type(result))
